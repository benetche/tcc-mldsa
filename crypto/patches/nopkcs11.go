...
type FactoryOpts struct {
	...
	MLDSA   *MLDSAOpts `json:"MLDSA,omitempty" yaml:"MLDSA,omitempty"`
}
...
func initFactories(config *FactoryOpts) error {
	...
	if config.Default == "MLDSA" && config.MLDSA != nil {
		f := &MLDSAFactory{}
		var err error
		defaultBCCSP, err = initBCCSP(f, config)
		if err != nil {
			return errors.Wrapf(err, "Failed initializing MLDSA BCCSP")
		}
	}
